...
const TestimonialClientes = () => {
  return (
    ...
    <div className="carouselDiv" >
      ...
      <div className="carousel-item">
        <img src="./img/logoLuArtesCircle.png" alt="Testimonial" className="testimonial-image" />
        <h5 className="testimonial-text">
      ...
      <div className="carousel-item">
        <img src="./img/priscilaPontesNailsDesign.png" alt="Testimonial" className="testimonial-image" />
        <h5 className="testimonial-text">

        ...
        <div className="testimonialsList">
          <div className="testimonial">
            <p className="testimonialText">
              A Meu Digital fez um trabalho incrível para impulsionar a nossa
              presença online. Nossas vendas aumentaram significativamente desde
              então.
            </p>
            <p className="testimonialAuthor">- LuArtes</p>
          </div>
          <div className="testimonial">
            <p className="testimonialText">
              Estou muito satisfeito com os serviços da Meu Digital. Eles
